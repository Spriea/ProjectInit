...
- (void)setupChildView{
    ...
    CGRect contFrame = contFrame = CGRectMake(0, 0, kSCALE_X(300), kSCALE_X(340));;
...
//    contView.clipsToBounds = YES;
    ...
    contView.image = kImageInstance(@"version_back");
